...
### Syntax
    ...
    offset-block-start: 3px         /* <length> values */
    offset-block-start: 2.4em
    
    offset-block-start: 10%         /* <percentage>s of the width or height of the containing block */
...
The `offset-block-start` property takes the same values as the [`left`][5] property.
...
The definition of 'offset-block-start' in that specification.][18]
Editor's Draft
Initial definition
...
[18]: http://dev.w3.org/csswg/css-logical-props/#propdef-offset-block-start
