...
The `margin-block-end` property takes the same values as the [`margin-left`][5] property.
...
The definition of 'margin-block-end' in that specification.][19]
Editor's Draft
Initial definition
...
[19]: http://dev.w3.org/csswg/css-logical-props/#propdef-margin-block-end
