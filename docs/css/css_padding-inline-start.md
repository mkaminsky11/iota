...
It relates to [`padding-block-start`][9], [`padding-block-end`][10], and [`padding-inline-end`][11], which define the other paddings of the element.
...
The `padding-inline-start` property takes the same values as the [`padding-left`][5] property.
...
The definition of 'padding-inline-start' in that specification.][18]
Editor's Draft
Initial definition
...
[18]: http://dev.w3.org/csswg/css-logical-props/#propdef-padding-inline-start
