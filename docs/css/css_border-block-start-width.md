...
The definition of 'border-block-start-width' in that specification.][19]
Editor's Draft
Initial definition
...
[`border-block-end-width`][9], 
[`border-inline-start-width`][10], 
[`border-inline-end-width`][11], 
...
[19]: http://dev.w3.org/csswg/css-logical-props/#propdef-border-block-start-width
