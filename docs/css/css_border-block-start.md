...
The `border-block-start` [CSS][1] property is a shorthand property for setting the individual logical block start border property values in a single place in the style sheet. `border-block-start` can be used to set the values for one or more of: [`border-block-start-width`][2], [`border-block-start-style`][3], [`border-block-start-color`][4]. It maps to a physical border depending on the element's writing mode, directionality, and text orientation. It corresponds to the [`border-top`][5], [`border-right`][6], [`border-bottom`][7], or [`border-left`][8] property depending on the values defined for [`writing-mode`][9], [`direction`][10], and [`text-orientation`][11].

It relates to [`border-block-end`][12], [`border-inline-start`][13], and [`border-inline-end`][14], which define the other borders of the element.
...
The definition of 'border-block-start' in that specification.][27]
Editor's Draft
Initial definition
...
[`border-block-start-width`][2], 
[`border-block-end-width`][48], 
[`border-inline-start-width`][49], 
[`border-inline-end-width`][50], 
[`border-block-start-style`][3], 
[`border-block-end-style`][51], 
[`border-inline-start-style`][52], 
[`border-inline-end-style`][53], 
[`border-block-start-color`][4], 
[`border-block-end-color`][54], 
[`border-inline-start-color`][55], 
[`border-inline-end-color`][56], 
[`border-block-start`][57], 
[`border-block-end`][12], 
...
[27]: http://dev.w3.org/csswg/css-logical-props/#propdef-border-block-start
...
[48]: https://developer.mozilla.org/en/docs/Web/CSS/border-block-end-width "The border-block-end-width CSS property defines the width of the logical block end border of an element, which maps to a physical border width depending on the element's writing mode, directionality and text orientation. I.e. it corresponds to the border-top-width, border-right-width, border-bottom-width or border-left-width property depending on the values defined for writing-mode, direction and text-orientation."
...
[51]: https://developer.mozilla.org/en/docs/Web/CSS/border-block-end-style "The border-block-end-style CSS property defines the style of the logical block end border of an element, which maps to a physical border style depending on the element's writing mode, directionality and text orientation. I.e. it corresponds to the border-top-style, border-right-style, border-bottom-style or border-left-style property depending on the values defined for writing-mode, direction and text-orientation."
...
[54]: https://developer.mozilla.org/en/docs/Web/CSS/border-block-end-color "The border-block-end-color CSS property defines the color of the logical block end border of an element, which maps to a physical border color depending on the element's writing mode, directionality and text orientation. I.e. it corresponds to the border-top-color, border-right-color, border-bottom-color or border-left-color property depending on the values defined for writing-mode, direction and text-orientation."
