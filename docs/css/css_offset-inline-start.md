...
It relates to [`offset-block-start`][9], [`offset-block-end`][10], and [`offset-inline-end`][11], which define the other offsets of the element.
...
### Syntax
    ...
    offset-inline-start: 3px         /* <length> values */
    offset-inline-start: 2.4em
    
    offset-inline-start: 10%         /* <percentage>s of the width or height of the containing block */
...
The `offset-inline-start` property takes the same values as the [`left`][5] property.
...
The definition of 'offset-inline-start' in that specification.][18]
Editor's Draft
Initial definition
...
[18]: http://dev.w3.org/csswg/css-logical-props/#propdef-offset-inline-start
