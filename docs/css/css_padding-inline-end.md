...
The `padding-inline-end` property takes the same values as the [`padding-left`][5] property.
...
The definition of 'padding-inline-end' in that specification.][18]
Editor's Draft
Initial definition
...
[18]: http://dev.w3.org/csswg/css-logical-props/#propdef-padding-inline-end
