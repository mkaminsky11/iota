...
The definition of 'border-inline-end-color' in that specification.][19]
Editor's Draft
Initial definition
...
[19]: http://dev.w3.org/csswg/css-logical-props/#propdef-border-inline-end-color
