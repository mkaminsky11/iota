...
### Syntax
    ...
    offset-block-end: 3px         /* <length> values */
    offset-block-end: 2.4em
    
    offset-block-end: 10%         /* <percentage>s of the width or height of the containing block */
...
The `offset-block-end` property takes the same values as the [`left`][5] property.
...
The definition of 'offset-block-end' in that specification.][18]
Editor's Draft
Initial definition
...
[18]: http://dev.w3.org/csswg/css-logical-props/#propdef-offset-block-end
...
[31]: https://developer.mozilla.org/en/docs/Web/CSS/offset-block-end "The offset-block-end CSS property defines the logical block end offset of an element, which maps to a physical offset depending on the element's writing mode, directionality and text orientation. I.e. it corresponds to the top, right, bottom or left property depending on the values defined for writing-mode, direction and text-orientation."
